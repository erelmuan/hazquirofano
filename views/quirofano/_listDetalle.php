...
<div class="detalle-expand" style="padding-left: 20px;padding-right: 20px;">
    ...
    <div style="font-size: 16px;padding-top: 4px;padding-bottom: 4px;"><b>ANESTESIOLOGO</b></div>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'header' => Html::a('Agregar', 'index.php?r=quirofano/addnombre&id_maestro='.$id_maestro, [
                ...
                'buttons' => [
                    ...
                    if ($action === 'deleteDetalle') {
                        $url ='index.php?r=quirofano/deletedetalle&id_detalle='.$searchModel->id.'&id_maestro='.$searchModel->id_quirofano;
                        return $url;
                    }
                }
            ],

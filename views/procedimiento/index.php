        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Create new Procedimientos','class'=>'btn btn-secondary']).
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="fas fa-list-alt"></i> Procedimientos listing',

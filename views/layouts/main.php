        ...
        <div class="col-md-3 left_col">
            ...
            <div class="left_col scroll-view">
                ...
                <div class="navbar nav_title" style="border: 0;">
                    <center class="site_title"><i class="fa fa-hospital-o"></i> <span>HazQuirofano</span> </center><center id="version" style="color:white; font-size: 10px;">Version: 1.0.0</center>
                </div>
...
//   echo Growl::widget($notificacion);
// }
//
//
//
...
?>
        ...
        <footer>
              <center>Hospital "Artémides ZATTI" - Rivadavia 391 - (8500) Viedma - Río Negro <br />

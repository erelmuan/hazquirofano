...
$pdf->Text(14,$Inicio,"APELLIDO Y NOMBRE:");
$pdf->SetFont('Times','',10);
$pdf->Text(55,$Inicio,$model->paciente->apellido.' '.$model->paciente->nombre);
// $pdf->SetFont('Times','B',10);
...
$Inicio=$Inicio +8;
$pdf->SetFont('Times','B',10);
$pdf->Text(14,$Inicio ,"EDAD:");
$pdf->SetFont('Times','',10);
$pdf->Text(27,$Inicio ,$model->ayudantes);
$pdf->SetFont('Times','B',10);
$pdf->Text(80,$Inicio,"NHC:");
$pdf->SetFont('Times','',10);
$pdf->Text(90,$Inicio,$model->paciente->hc);
$pdf->SetFont('Times','B',10);
$pdf->Text(125,$Inicio,"DNI:");
$pdf->SetFont('Times','',10);
$pdf->Text(143,$Inicio,$model->paciente->num_documento);

...
/**
 * DiasSemanalesController implements the CRUD actions for DiasSemanales model.
 */
class DiasSemanalesController extends Controller
{
    ...
    /**
     * Displays a single DiasSemanales model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new DiasSemanales model.
    ...
    /**
     * Finds the DiasSemanales model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return DiasSemanales the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = DiasSemanales::findOne($id)) !== null) {
            return $model;
        } else {
